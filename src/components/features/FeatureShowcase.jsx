  ...
  return (
    <section className="grid gap-6 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:items-center">
      <div className="space-y-4">
        ...
        <h3 className="text-3xl font-semibold tracking-tight text-foreground sm:text-4xl">{featureShowcase.title}</h3>
        <p className="max-w-2xl text-base leading-7 text-muted">{featureShowcase.description}</p>
      </div>
