    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-[#0a0a0c]/80 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 sm:px-8 lg:px-10">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            href="/cli"
            className="rounded-full border border-purple-500/40 bg-purple-500/5 px-4 py-1.5 text-xs font-semibold text-purple-300 transition hover:border-purple-400 hover:bg-purple-500/20"
          >
            Demo CLI
          </Link>
